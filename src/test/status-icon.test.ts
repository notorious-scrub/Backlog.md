...
describe("Status Icon Component", () => {
	describe("getStatusStyle", () => {
		...
		test("returns correct style for On Hold status", () => {
			const style = getStatusStyle("On Hold");
			expect(style.icon).toBe("◌");
	...
	describe("getStatusColor", () => {
		test("returns correct color for each status", () => {
			...
			expect(getStatusColor("On Hold")).toBe("magenta");
	...
	describe("getStatusIcon", () => {
		test("returns correct icon for each status", () => {
			...
			expect(getStatusIcon("On Hold")).toBe("◌");
	...
	describe("formatStatusWithIcon", () => {
		test("formats status with correct icon", () => {
			...
			expect(formatStatusWithIcon("On Hold")).toBe("◌ On Hold");
